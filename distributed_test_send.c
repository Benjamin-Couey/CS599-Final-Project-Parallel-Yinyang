...
//Example compilation
//mpicc -g distributed_test_send.c -lm -o distributed_test_send
//mpirun -np 2 -hostfile myhostfile.txt ./distributed_test_send 10 10 10 1 MSD_year_prediction_normalize_0_1_100k.txt 0
